        ...
        <div class="w-full h-full p-10 flex-col  hidden add-crew-form overflow-y-auto">
            ...
            <div class="flex items-center">
                <div class="flex-1 flex flex-col px-12">
                    ...
                    <input type="email" placeholder="Email (Optional)" class="mb-5 flex-1 bg-gray-50 rounded-md transform transition-colors duration-300" id="crewEmail" name="email" value="<?php if ($row['email'] != null) {
                                                                                                                                                                                                    echo $row['email'];
                                                                                                                                                                                                } ?>">
            ...
            <div class="mb-24 mt-5">
                <div class="flex items-center">
                    ...
                    <input type="number" placeholder="Land Number (Optional)" class="mb-5 flex-1 bg-gray-50 rounded-md transform transition-colors duration-300" id="crewLandLine" name="landline" value="<?php if (!($row['LAN_no'] == null)) {
                                                                                                                                                                                                                echo $row['LAN_no'];
                                                                                                                                                                                                            } ?>">
                </div>
                ...
                <div class="flex items-center mb-5">
                    <div class="flex flex-col">
                        ...
                        <select class="px-3 py-2 w-28 rounded" id="crewPosition" name="position">
                            <option value="Chef" <?php if ($row['position'] == 'Chef') {
                                                        echo "selected='selected'";
                                                    } ?>>Chef</option>
                            <!-- <option value="Staff">Staff</option> -->
                            <option value="Helper" <?php if ($row['position'] == 'Helper') {
                                                        echo "selected='selected'";
                                                    } ?>>Helper</option>
                    ...
                    <div class="flex flex-col mx-5">
                        ...
                        <select class="px-3 py-2 w-28 rounded" id="crewShift" name="shift">
                            <option value="Day" <?php if ($row['shift'] == 'Day') {
                                                    echo "selected='selected'";
                                                } ?>>Day</option>
                            <option value="Night" <?php if ($row['shift'] == 'Night') {
                                                        echo "selected='selected'";
                                                    } ?>>Night</option>
                        </select>
                    </div>

                    <input type="number" placeholder="Salary" class="-mb-7 mx-5 bg-gray-50 rounded-md transform transition-colors duration-300" id="crewSalary" name="salary" value="<?php if (!($row['Salary'] == null)) {
                                                                                                                                                                                            echo $row['Salary'];
                                                                                                                                                                                        } else {
                                                                                                                                                                                            echo '0';
                                                                                                                                                                                        } ?>">
