...
if (isset($_POST['query'])) {
    ...
    if(empty($alreadAdded)) {
        ...
        $message = "No Results Found For Ingredient - " . $_POST['query'];
    }else {
        $sql = "SELECT * FROM ingredient WHERE name LIKE '%" . $_POST['query'] . "%' AND id NOT IN ('$alreadAdded');";
        $message = "No Results Found Or Already selected For Ingredient - " . $_POST['query'];
    }
