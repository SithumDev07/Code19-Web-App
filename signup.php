    ...
    ?>
      ...
      <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="./signup.php" method="POST">
        ...
        <div class="mb-4 relative">
          ...
          <p class="text-red-500 text-xs italic" id="alreadyTaken"><?php if (isset($_GET['error']) && $_GET['error'] == 'username_already_taken') {
                                                                      echo 'Username is already exists, try another';
                                                                    } ?></p>
        </div>
        <div class="mb-4 relative">
          <label class="block text-gray-700 text-sm font-bold mb-2" for="username">
          ...
          <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="email" placeholder="Email address" name="email" value="<?php if (isset($_GET['error']) && $_GET['error'] == 'username_already_taken') {
                                                                                                                                                                                                                              echo $_GET['email'];
                                                                                                                                                                                                                            } ?>">
          <i class="fas fa-check-circle text-green-500 absolute top-10 right-2"></i>
          <i class=" fas fa-exclamation-circle text-red-500 absolute top-10 right-2"></i>
        ...
        <p class="inline-block align-baseline font-bold text-sm text-gray-500">
          Already have an account? <a href="./login.php" class="text-blue-500 hover:text-blue-800 ml-1">Sign in</a>
        </p>
      </form>
